/*
 ============================================================================
 Name        : pi2.cpp
 Author      : Sergio Rodriguez Lumley & Daniel Guerrero Martinez
 Version     :
 Copyright   : GNU Open Souce and Free license
 Description : Tutorial 3. Aproximacion de PI.
	Realiza el calculo de PI en X numero de iteraciones. Las iteraciones
	se pueden pasar por parametros o bien se ejecutara automaticamente con
	10 iteraciones.
 ============================================================================
 */
#include <math.h> 
